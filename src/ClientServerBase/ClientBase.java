...
public class ClientBase {
    public static void main(String args[]) {
        try {
            // Apre una connessione verso un server in ascolto sulla porta 7777. In questo caso utilizziamo localhost che corrisponde all’indirizzo IP 127.0.0.1
