		...
		try {
			...
			while(true) {
				...
				for(int i = 0; i < messaggioRicevuto.length(); i++) {
					if((((((((((messaggioRicevuto.charAt(i) == 'a') || (messaggioRicevuto.charAt(i) == 'e')) || (messaggioRicevuto.charAt(i) == 'i')) || (messaggioRicevuto.charAt(
							i) == 'o')) || (messaggioRicevuto.charAt(i) == 'u')) || (messaggioRicevuto.charAt(i) == 'A')) || (messaggioRicevuto.charAt(
							i) == 'E')) || (messaggioRicevuto.charAt(i) == 'I')) || (messaggioRicevuto.charAt(i) == 'O')) || (messaggioRicevuto.charAt(
							i) == 'U'))
						cont++;
				}
